...
class GetTotalView(APIView):
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response({'error' : 'Something went wrong when retrieving total costs'},
            status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class GetItemTotalView(APIView):
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response({'error' : 'Something went wrong when getting total number of items'}, 
            status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class UpdateItemView(APIView):
    def put(self, request, format=None):
        ...
        try:
            ...
            return Response({'error' : 'Count value must be a integer'},
            status=status.HTTP_404_NOT_FOUND)
