        ...
        <div>
            ...
            <div className="bg-white">
                ...
                <form onSubmit={e => onSubmit(e)} className="mt-4 border-t border-gray-200">
                  ...
                  {/* filttrado por precios */}
                  <Disclosure as="div" className="border-gray-200 px-4 border-t-2 py-6">
                    {({open}) => (
                      <>
                 ...
                 {/* filttrado por sort by */}
                  <Disclosure as="div" className="border-gray-200 border-t-2 border-b-2 px-4 py-6">
                    {({open}) => (
                      <>
                        <h3 className='-mx-2 -my-3 flow-root'>
                          <Disclosure.Button className='px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500'>
                          ...
                          <Disclosure.Panel className="pt-6">
                            <div className='space-y-6'>
                              <div className='form-group'> 
                                  <label htmlFor='sortBy' className='mr-3 min-w-0 flex-1 text-gray-500'>Ver por</label>
                                  <select
                                    className='my-2 font-sofiapro-light inline-flex justify-center w-full'
                                    id='sortBy'
                                    name='sortBy'
                                    onChange={e => onChange(e)}
                                    value={sortBy}
                                  >
                                    <option className='font-sofiapro-light' value='created_at'>Fecha</option>
                                    <option className='font-sofiapro-light' value='value'>Precio</option>
                                    <option className='font-sofiapro-light' value='name'>Nombre</option>
                                    <option className='font-sofiapro-light' value='sold'>Ventas</option>
                                  </select>
                              </div>
                              <div className='form-group border-y-1'> 
                                  <label htmlFor='sortBy' className='mr-3 min-w-0 flex-1 text-gray-500'>Orden</label>
                                  <select
                                    className='my-2 font-sofiapro-light inline-flex justify-center w-full'
                                    id='order'
                                    name='order'
                                    ...
                                    value={order}
                                  >
                                    <option value='asc' className='font-sofiapro-light'>A - Z</option>
                                    <option value='desc' className='font-sofiapro-light'>Z - A</option>
                                  </select>
                              </div>
                            </div>
                          </Disclosure.Panel>
                  ...
                  <button
                    type="submit"
                    className="mt-3 float-right inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Buscar
                  </button>
                </form>
        ...
        searched_products !== undefined && searched_products.length})</h1>
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              {/* Filters */}
              <form onSubmit={e => onSubmit(e)} className="mt-4 border-t border-gray-200 hidden lg:block">
